...
export default [
  {
    ...
    image: mangoImg,
    badge: "Best Seller",
    description: "Premium GI-tagged Kesar mangoes from Gir, Gujarat. Rich saffron colour, incredible aroma, and unmatched sweetness.",
  },
  {
    id: 2,
    name: "Kesar Mango (Economy)",
    price: "₹900 / dozen",
    category: "Fresh Mangoes",
    image: kesarImg,
    badge: null,
    description: "Same authentic Kesar flavour at a budget-friendly price. Perfect for families and bulk orders.",
  },
  {
    id: 3,
